    ...
    <div className="min-h-screen bg-slate-950 text-white pt-24 pb-24 px-6 flex-1">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6 text-white tracking-tight">Installation <span className="text-lime-500">Guides</span></h1>
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-4 rounded-xl text-left transition-all font-medium ${
                      activeDevice === device.id 
                        ? "bg-lime-500 text-slate-950 shadow-[0_0_20px_rgba(132,204,22,0.3)]" 
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 md:p-12 shadow-xl">
              ...
              {activeDevice === "firestick" && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <div className="flex items-center gap-4 mb-8">
                    <div className="w-16 h-16 bg-slate-800 rounded-2xl flex items-center justify-center text-lime-500">
                  ...
                  <div className="space-y-8">
                    <div className="flex gap-4">
                      <div className="flex flex-col items-center">
                        <div className="w-8 h-8 rounded-full bg-lime-500 text-slate-950 flex items-center justify-center font-bold">1</div>
                    ...
                    <div className="flex gap-4">
                      <div className="flex flex-col items-center">
                        <div className="w-8 h-8 rounded-full bg-lime-500 text-slate-950 flex items-center justify-center font-bold">2</div>
                        <div className="w-0.5 h-full bg-slate-800 mt-2"></div>
                      </div>
                      <div className="pb-8">
                    ...
                    <div className="flex gap-4">
                      <div className="flex flex-col items-center">
                        <div className="w-8 h-8 rounded-full bg-lime-500 text-slate-950 flex items-center justify-center font-bold">3</div>
                        <div className="w-0.5 h-full bg-slate-800 mt-2"></div>
                      </div>
                      <div className="pb-8">
                        <h4 className="text-xl font-bold mb-2">Download TiviMate</h4>
                        <p className="text-slate-300 mb-4">In the Downloader app URL bar, type the official TiviMate shortcode: <strong className="text-lime-500">28907</strong> and click Go. Install the app when prompted.</p>
                      </div>
                    </div>

                    <div className="flex gap-4">
                      <div className="flex flex-col items-center">
                        <div className="w-8 h-8 rounded-full bg-lime-500 text-slate-950 flex items-center justify-center font-bold">4</div>
                      </div>
                      <div>
              ...
              {activeDevice === "smarttv" && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <div className="bg-lime-500/10 border border-lime-500/20 rounded-xl p-4 mb-8">
                    <p className="text-sm text-lime-200">Note: The "Smart IPTV" app requires a one-time activation fee of ~5.49 EUR after a 7-day trial. This fee goes to the app developer, not to us.</p>
                  </div>
                  <ul className="space-y-4 list-decimal list-inside text-slate-300">
                    <li className="pl-2 pb-2 border-b border-slate-800">Open your TV's App Store and search for <strong>Smart IPTV</strong>.</li>
                    <li className="pl-2 pb-2 border-b border-slate-800">Install the app and open it. You will see a <strong>MAC Address</strong> displayed on the screen. Write this down.</li>
                    <li className="pl-2 pb-2 border-b border-slate-800">On your phone or computer, visit <strong>siptv.app/mylist</strong>.</li>
                    <li className="pl-2 pb-2 border-b border-slate-800">Enter your MAC address in the "MAC" field.</li>
                    <li className="pl-2 pb-2 border-b border-slate-800">Paste your <strong>M3U Link</strong> (sent to your email) in the "URL" field and click "Send".</li>
                    <li className="pl-2 pb-2 border-b border-slate-800">Restart the Smart IPTV app on your TV. The channels will now load.</li>
                  </ul>
                </div>
              )}
              ...
              {(activeDevice === "android" || activeDevice === "pc") && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 flex flex-col items-center justify-center text-center py-12">
                  <div className="w-24 h-24 bg-slate-950 rounded-full flex items-center justify-center text-lime-500 mb-6">
